...
const CommentGererLeStressEtLanxieteAuQuotidienConseilsPratiquesSomaire2 = ({
  slug,
}: {
  slug: string;
}) => {
...
export default CommentGererLeStressEtLanxieteAuQuotidienConseilsPratiquesSomaire2;
